...
class Module:
  ...
  Defines the forward/backward contract, plus default (empty)
  parameter and gradient-reset behavior for modules that have
  ...
  def zero_grad(self):
    ...
    No-op by default. In this project, resetting stored gradients
    is handled by the optimizer (Chapter 9) directly, not by
    individual modules -- you will not need to override this
    method anywhere, including in Linear.
    """
    pass
